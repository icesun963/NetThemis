...
namespace fastJSON
{
    ...
    internal sealed class Reflection
    {
        ...
        internal Getters[] GetGetters(Type type, bool showreadonly)
        {
            ...
            var isAnonymousType = type.Name.IndexOf("AnonymousType") >= 0;
            foreach (PropertyInfo p in props)
            {

                if (!p.CanWrite && showreadonly == false && !isAnonymousType) continue;
            ...
            getters.Sort((x,y)=>x.Name.CompareTo(y.Name));
